...
csvheaders= {'panel_a_TPJ_social','panel_a_TPJ_confidence','panel_a_TPJ_interaction', ...
             'panel_a_dmPFC_social','panel_a_dmPFC_confidence','panel_a_dmPFC_interaction', ...
             'panel_b_TPJ_self','panel_b_TPJ_other', ...
             'panel_b_dmPFC_self','panel_b_dmPFC_other'};
csvdata= [beta_HRF{1}.full(:,1) beta_HRF{1}.full(:,2) beta_HRF{1}.full(:,3) ...
          beta_HRF{2}.full(:,1) beta_HRF{2}.full(:,2) beta_HRF{2}.full(:,3) ...
          beta_HRF{1}.self(:,1) beta_HRF{1}.other(:,1) ...
          beta_HRF{2}.self(:,1) beta_HRF{2}.other(:,1)];
csvwrite_with_headers('SourceData/Figure7',csvdata,csvheaders);
