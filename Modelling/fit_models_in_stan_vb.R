...
## SPECIFY MODELS FOR FITTING (ABBREVIATIONS SAME AS IN PAPER; * DENOTED BY S)
...
sd_alpha_lb <- 0
sd_alpha_ub <- 1
# group priors and bounds on sensory covariance
mu_rho_prior_mu <- 0
mu_rho_prior_sd <- .5
mu_rho_lb <- -.95
mu_rho_ub <- .95
...
for (m in 1:length(models)) {
  ...
  data <- list(Nblocks, maxTrials=Ntrials, Ns=Nsubjects, subNtrials=subNtrials,
               ...
               mu_rho_prior_mu, mu_rho_prior_sd, mu_rho_lb, mu_rho_ub, sd_rho_lb, sd_rho_ub,
  ...
  for (iter in 1:Nreruns) {
      ...
      if (models[m] == 'S_B1T1P1') {
      ...
      } else if (models[m] == 'QS_B1T1P1') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1','beta1','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0','beta1','alpha','factor')
      } else if (models[m] == 'QS_B1T2P1') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0','beta1_s','beta1_o','alpha','factor')
      } else if (models[m] == 'QS_B2T1P1') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1','beta1','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1','alpha','factor')
      } else if (models[m] == 'QS_B2T2P1') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','factor')
        ...
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','factor')
      } else if (models[m] == 'TS_B1T1P1') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1','beta1','mu_alpha','alpha','mu_rho','rho','mu_factor','factor','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1','mu_alpha','mu_rho','mu_factor')
        subject_param <- c('sigma','beta0','beta1','alpha','rho','factor')
      } else if (models[m] == 'TS_B1T2P1') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_rho','rho','mu_factor','factor','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1_s','mu_beta1_o','mu_alpha','mu_rho','mu_factor')
        subject_param <- c('sigma','beta0','beta1_s','beta1_o','alpha','rho','factor')
      } else if (models[m] == 'TS_B2T1P1') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1','beta1','mu_alpha','alpha','mu_rho','rho','mu_factor','factor','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1','mu_alpha','mu_rho','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1','alpha','rho','factor')
      } else if (models[m] == 'TS_B2T2P1') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_rho','rho','mu_factor','factor','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_rho','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','rho','factor')
      ...
      } else if (models[m] == 'QS_B1T1P0') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1','beta1','mu_alpha','alpha','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1','mu_alpha')
        subject_param <- c('sigma','beta0','beta1','alpha')
      } else if (models[m] == 'QS_B1T2P0') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1_s','mu_beta1_o','mu_alpha')
        subject_param <- c('sigma','beta0','beta1_s','beta1_o','alpha')
      } else if (models[m] == 'QS_B2T1P0') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1','beta1','mu_alpha','alpha','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1','mu_alpha')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1','alpha')
      } else if (models[m] == 'QS_B2T2P0') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha')
      } else if (models[m] == 'QA_B2T2P0') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha')
        ...
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha')
      } else if (models[m] == 'TS_B1T1P0') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1','beta1','mu_alpha','alpha','mu_rho','rho','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1','mu_alpha','mu_rho')
        subject_param <- c('sigma','beta0','beta1','alpha','rho')
      } else if (models[m] == 'TS_B1T2P0') {
        parameters <- c('sigma','mu_beta0','beta0','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_rho','rho','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0','mu_beta1_s','mu_beta1_o','mu_alpha','mu_rho')
        subject_param <- c('sigma','beta0','beta1_s','beta1_o','alpha','rho')
      } else if (models[m] == 'TS_B2T1P0') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1','beta1','mu_alpha','alpha','mu_rho','rho','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1','mu_alpha','mu_rho')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1','alpha','rho')
      } else if (models[m] == 'TS_B2T2P0') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_rho','rho','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_rho')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','rho')
      } else if (models[m] == 'SS_B2T2P1') {
        parameters <- c('sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','factor')
      }
      ...
      if (models[m] == 'S_B1T1P1') { 
        ...
        subject_param$beta1 <- colMeans(samp$beta1)
        subject_param$alpha <- colMeans(samp$alpha)
        subject_param$rho <- colMeans(samp$rho)
        subject_param$factor <- colMeans(samp$factor)
        subject_predict$ppk <- apply(samp$ppk,c(2,3),mean)
        subject_predict$ppx <- apply(samp$ppx,c(2,3),mean)
        subject_predict$ppCs <- apply(samp$ppCs,c(2,3),mean)
