...
models <- c('S_B2T2P1_U','Q_B2T2P1_U','T_B2T2P1_U')
...
for (m in 1:length(models)) {
  ...
  for (iter in 1:Nreruns) {
      ...
      # model
      if (models[m] == 'S_B2T2P1_U') {
        parameters <- c('mu_powerL','mu_powerG','mu_averse','powerL','powerG','averse','sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_factor','factor','ppx','ppCs','ppCo','ppEVr','ppEVs','ppPgamble','lik','log_lik')
        group_param <- c('mu_powerL','mu_powerG','mu_averse','mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_factor')
        subject_param <- c('powerL','powerG','averse','sigma','beta0_s','beta0_o','beta1_s','beta1_o','factor')
      } else if (models[m] == 'Q_B2T2P1_U') {
        parameters <- c('mu_powerL','mu_powerG','mu_averse','powerL','powerG','averse','sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppEVs','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_powerL','mu_powerG','mu_averse','mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('powerL','powerG','averse','sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','factor')
      } else if (models[m] == 'T_B2T2P1_U') {
        parameters <- c('mu_powerL','mu_powerG','mu_averse','powerL','powerG','averse','sigma','mu_beta0_s','mu_beta0_o','beta0_s','beta0_o','mu_beta1_s','mu_beta1_o','beta1_s','beta1_o','mu_alpha','alpha','mu_factor','factor','mu_factor','factor','ppk','ppx','ppCs','ppCo','ppEVr','ppEVs','ppPgamble','ppd','ppu','lik','log_lik')
        group_param <- c('mu_powerL','mu_powerG','mu_averse','mu_beta0_s','mu_beta0_o','mu_beta1_s','mu_beta1_o','mu_alpha','mu_factor')
        subject_param <- c('powerL','powerG','averse','sigma','beta0_s','beta0_o','beta1_s','beta1_o','alpha','factor')
      }
      ...
      if (models[m] == 'S_B2T2P1_U') { 
        ...
        subject_predict$ppEVs <- apply(samp$ppEVs,c(2,3),mean)
      } else if (models[m] == 'Q_B2T2P1_U') { 
        subject_param$sigma <- colMeans(samp$sigma)
        subject_param$beta0_s <- colMeans(samp$beta0_s)
        subject_param$beta0_o <- colMeans(samp$beta0_o)
